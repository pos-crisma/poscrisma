                        ...
                        Row(
                          ...
                          children: [
                            ...
                            ValueListenableBuilder(
                              ...
                              builder: (context, value, child) {
                                return Text(
                                  value.room.hosted?.length.toString() ?? "0",
                                  style: Theme.of(context)
                                      .textTheme
                                      .labelLarge! //
                                      .copyWith(
                      ...
                      builder: (context, value, child) {
                        return RichText(
                          text: TextSpan(
                            ...
                            children: [
                              TextSpan(
                                text: value.room.blockName ?? "Não adicionado",
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyLarge! //
                                    .copyWith(
                      ...
                      builder: (context, value, child) {
                        return RichText(
                          text: TextSpan(
                            ...
                            children: [
                              TextSpan(
                                text: value.room.roomType == "Couple"
                                    ? 'Casal'
                      ...
                      builder: (context, value, child) {
                        return RichText(
                          text: TextSpan(
                            ...
                            children: [
                              TextSpan(
                                text: value.room.availability == true
                                    ? 'Disponivel'
                                    : "Indisponivel",
                                style: Theme.of(context)
                                    .textTheme
                          ...
                          if (user != null) {
                            return user.userType == "Young"
                                ? HostedYoungCard(
                                    ...
                                    // isGuest: user?. ?? false,
                                    godFather: user.godParents?.godFather ??
                                        "Padrinho",
                                    godMother: user.godParents?.godMother ??
                                        "Madrinha",
                                ...
                                : HostedCard(
                                    ...
                                    type: switch (user.userType) {
                                      "GodParent" => user.userGender
                                                  ?.toLowerCase() ==
                                              UserGender.Male.name.toLowerCase()
                                          ? "Padrinho"
                                          : "Madrinha",
                                      "Voluntary" => user.userGender
                                                  ?.toLowerCase() ==
                                              UserGender.Male.name.toLowerCase()
                                          ? "Voluntario"
                                          : "Voluntaria",
